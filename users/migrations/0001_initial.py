    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', sorl.thumbnail.fields.ImageField(blank=True, help_text='Profile Picture', storage=users.storage.OverwriteStorage(), upload_to=users.models.profile_image_upload_path, validators=[users.models.validate_image_extension], verbose_name='Profile Picture')),
