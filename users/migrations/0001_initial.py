    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', imagekit.models.fields.ProcessedImageField(blank=True, help_text='Profile Picture', upload_to=users.models.profile_image_upload_path, verbose_name='Profile Picture')),
                ('cover_image', imagekit.models.fields.ProcessedImageField(blank=True, help_text='Profile Cover Picture', upload_to=users.models.profile_cover_image_upload_path, verbose_name='Profile Cover Picture')),
            ],
            options={
